<template>
  <div :class="$style.login_all_flex">
    <div :class="$style.login_left_flex">
      <div :class="$style.login_div_flex">
        ...
        <form id="loginform" :class="$style.login_form">
          <div>
            <input type="text" placeholder="Username" :class="$style.login_form_input">
          </div>
          <div>
            <input type="password" placeholder="Password" :class="$style.login_form_input">
          </div>
          <button type="submit" id="login-button" :class="$style.login_form_login_button">Login</button>
        </form>
      </div>
    ...
    <div :class="$style.login_right_flex">  <img src="https://tailwindui.com/img/component-images/dark-project-app-screenshot.png" alt="Product screenshot" class=" rounded-xl shadow-xl ring-1 ring-gray-400/10 self-center fixed -right-64 top-48 h-3/5" /></div>
