  ...
  <div class="button_flex">
    ...
    <div class="button_item">
      <button class="buttons"
        @click="
          store.changeRightSideBarContent(rightSideBarContentMap.FAVORITE_ROOM_LIST)
        "
      >
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="icons">
    ...
    <div class="button_item">
      <button class="buttons"
        @click="
          store.changeRightSideBarContent(rightSideBarContentMap.ROOM_SETTINGS)
        "
      >
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="icons">
...
<style lang="css">
@import "RightSideBarButton.module.css";
</style>
