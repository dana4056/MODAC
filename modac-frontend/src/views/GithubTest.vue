<template>
  ...
  <!-- {{articleStore.githubState}} -->
    ...
    <!-- <div> -->
      ...
      <GithubTest2 class="github_div" :moveCreateNewRepo="moveCreateNewRepo" :selectRepo="selectRepo"></GithubTest2>
    </div>
    <div v-if="articleStore.githubState == 22">
      <GithubTest22 class="github_div" :createNewRepo="createNewRepo" :user_info="user" :backPrev="backPrev"></GithubTest22>
    </div>
    <div v-if="articleStore.githubState == 3">
      <GithubTest3 class="github_div" :createCommit="createCommit" :user_info="user" :repo_info="repo" :backPrev="backPrev"></GithubTest3>
    </div>
    <div v-if="articleStore.githubState == 4">
      <GithubTest4 class="github_div" :user_info="user" :repo_info="repo" :backPrev="backPrev"></GithubTest4>
    </div>
    <div v-if="articleStore.githubState == 0">
      <iframe class="w-[50vw] h-[85vh]" src="https://github.com/login/oauth/authorize?client_id=${CLIENT_ID}&client_secret=${CLIENT_SECRETS}&scope=repo"></iframe>
    </div>
