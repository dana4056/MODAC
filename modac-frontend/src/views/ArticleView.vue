  ...
  <div :class="$style.article_container">
    <div :class="$style.article_container_above">
      ...
      <div :class="$style.buttons">
        ...
        <button type="button" class="text-white bg-[#24292F] hover:bg-[#24292F]/90 font-medium rounded-full text-sm px-5 py-2.5 text-center inline-flex items-center dark:hover:bg-[#050708]/30 mr-2 mb-2">
