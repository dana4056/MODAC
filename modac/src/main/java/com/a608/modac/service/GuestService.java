...
public interface GuestService {
	void deleteGuestInfo(final Long usersSeq, final Long roomsSeq); // 비공개 멀티룸 입장정보 삭제
	List<GuestResponse> findAllMyRooms(final Long usersSeq); // 나의 비공개방 리스트 보기.
	GuestResponse findMyRoom(final Long usersSeq, final Long roomsSeq); // 나의 비공개방(하나) 조회
