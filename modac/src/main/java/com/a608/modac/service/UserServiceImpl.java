...
<<<<<<< modac/src/main/java/com/a608/modac/service/UserServiceImpl.java
	...
	public UserServiceImpl(UserRepository userRepository, FollowRepository followRepository,
		ChatRoomRepository chatRoomRepository, JwtTokenProvider jwtTokenProvider,
		final RedisTemplate<String, DirectMessage> redisTemplate, final ChatDirectRepository chatDirectRepository) {
	...
	public void unFollowing(FollowRequest followRequest) {
		Follow following = followRepository.findFollowByFromUser_SeqAndToUser_Seq(followRequest.getFromSeq(),
			followRequest.getToSeq());
